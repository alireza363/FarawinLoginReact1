...
export default function RegisterPage() {
  ...
  let buttonValid = () => {
    if (passwordValid() && confirmValid() && mobileValid()) {
      return true;
    }
    return false;
  };
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative my-10">
        <div className="absolute top-0 right-0 w-full h-full opacity-70"></div>
        ...
        <button
          ...
          onClick={() => {
            if (buttonValid()) {
              setIsLoading(true);
              farawin.testRegister(mobile, password, username, (response) => {
